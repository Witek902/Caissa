...
void RunSearchTests()
{
    ...
    // drawing KPvK
    {
        ...
        TEST_EXPECT(std::abs(result[0].score) < 200);
        TEST_EXPECT(std::abs(result[1].score) < 200);
        TEST_EXPECT(std::abs(result[2].score) < 200);
        TEST_EXPECT(std::abs(result[3].score) < 200);
    }

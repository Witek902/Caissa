...
DEFINE_PARAM(LmrQuietNonPv, 67, -128, 256);
DEFINE_PARAM(LmrQuietTTCapture, 78, -128, 256);
DEFINE_PARAM(LmrQuietRefutation, 162, -128, 256);
DEFINE_PARAM(LmrQuietCutNode, 148, -128, 256);
DEFINE_PARAM(LmrQuietImproving, 76, -128, 256);
DEFINE_PARAM(LmrQuietInCheck, 72, -128, 256);

DEFINE_PARAM(LmrCaptureWinning, 61, -128, 256);
DEFINE_PARAM(LmrCaptureBad, 19, -128, 256);
DEFINE_PARAM(LmrCaptureCutNode, 70, -128, 256);
DEFINE_PARAM(LmrCaptureImproving, 24, -128, 256);
DEFINE_PARAM(LmrCaptureInCheck, 52, -128, 256);
DEFINE_PARAM(LmrTTHighDepth, 66, -128, 256);

DEFINE_PARAM(LmrDeeperTreshold, 81, 20, 200);
...
DEFINE_PARAM(HistoryPruningLinearFactor, 253, 100, 500);
DEFINE_PARAM(HistoryPruningQuadraticFactor, 130, 50, 200);

DEFINE_PARAM(AspirationWindowMaxSize, 513, 200, 1000);
...
DEFINE_PARAM(QSearchFutilityPruningOffset, 81, 50, 150);

DEFINE_PARAM(RfpDepth, 6, 5, 10);
DEFINE_PARAM(RfpMultiplier, 111, 80, 180);
DEFINE_PARAM(RfpTreshold, 14, 0, 20);

DEFINE_PARAM(SSEPruningMultiplier_Captures, 129, 50, 200);
...
DEFINE_PARAM(RazoringMarginBias, 23, 0, 25);

DEFINE_PARAM(ReductionStatOffset, 7253, 5000, 12000);
DEFINE_PARAM(ReductionStatDiv, 181, 10, 400);

DEFINE_PARAM(EvalCorrectionPawnsScale, 51, 1, 128);

...
DEFINE_PARAM(CaptFutilityPruningBase_Pawn, 97, 16, 500);
DEFINE_PARAM(CaptFutilityPruningBase_Knight, 455, 0, 1000);
DEFINE_PARAM(CaptFutilityPruningBase_Bishop, 494, 0, 1000);
DEFINE_PARAM(CaptFutilityPruningBase_Rook, 607, 0, 1500);
DEFINE_PARAM(CaptFutilityPruningBase_Queen, 1427, 0, 2000);
DEFINE_PARAM(CaptFutilityPruningScale, 150, 16, 512);

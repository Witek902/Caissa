...
DEFINE_PARAM(LmrScale_Quiets, 47, 20, 70);
DEFINE_PARAM(LmrBias_Quiets, 58, 20, 80);
DEFINE_PARAM(LmrScale_Captures, 41, 20, 70);
DEFINE_PARAM(LmrBias_Captures, 64, 20, 80);

DEFINE_PARAM(LmrQuietNonPv, 28, -128, 256);
DEFINE_PARAM(LmrQuietTTCapture, 66, -128, 256);
DEFINE_PARAM(LmrQuietRefutation, 162, -128, 256);
DEFINE_PARAM(LmrQuietCutNode, 175, -128, 256);
DEFINE_PARAM(LmrQuietImproving, 27, -128, 256);
DEFINE_PARAM(LmrQuietInCheck, 69, -128, 256);

DEFINE_PARAM(LmrCaptureWinning, 66, -128, 256);
DEFINE_PARAM(LmrCaptureBad, -29, -128, 256);
DEFINE_PARAM(LmrCaptureCutNode, 95, -128, 256);
DEFINE_PARAM(LmrCaptureImproving, -13, -128, 128);
DEFINE_PARAM(LmrCaptureInCheck, 21, -128, 256);
DEFINE_PARAM(LmrTTHighDepth, 13, -128, 256);

DEFINE_PARAM(FiftyMoveRuleEvalScale, 227, 120, 600);

DEFINE_PARAM(LmrDeeperTreshold, 84, 20, 200);

DEFINE_PARAM(ProbcutStartDepth, 5, 3, 8);
DEFINE_PARAM(ProbcutBetaOffset, 127, 80, 300);
DEFINE_PARAM(ProbcutBetaOffsetInCheck, 314, 100, 500);
...
DEFINE_PARAM(FutilityPruningStatscoreDiv, 405, 128, 1024);

DEFINE_PARAM(SingularitySearchMinDepth, 10, 5, 20);
DEFINE_PARAM(SingularitySearchScoreTresholdMin, 211, 100, 300);
DEFINE_PARAM(SingularitySearchScoreTresholdMax, 405, 200, 600);
...
DEFINE_PARAM(NmpEvalDiffDiv, 98, 16, 512);
...
DEFINE_PARAM(HistoryPruningLinearFactor, 224, 100, 400);
DEFINE_PARAM(HistoryPruningQuadraticFactor, 154, 60, 300);
DEFINE_PARAM(HistoryPruningMaxDepth, 9, 4, 12);

DEFINE_PARAM(AspirationWindowMaxSize, 553, 200, 800);
DEFINE_PARAM(AspirationWindow, 6, 5, 20);
DEFINE_PARAM(AspirationWindowScoreScale, 18, 8, 32);
...
DEFINE_PARAM(SingularExtDepthRedMul, 57, 32, 128);
DEFINE_PARAM(SingularExtDepthRedSub, 196, 0, 512);
DEFINE_PARAM(SingularDoubleExtensionMarigin, 14, 5, 25);
DEFINE_PARAM(SingularTripleExtensionMarigin, 52, 15, 100);
DEFINE_PARAM(SingularExtTTDepthMargin, 3, 1, 6);
DEFINE_PARAM(SingularExtPVBonus, 244, 64, 512);
DEFINE_PARAM(SingularFailHighNegExt, 2, 1, 4);
DEFINE_PARAM(SingularCutNodeNegExt, 2, 1, 4);
DEFINE_PARAM(SingularTTAlphaNegExt, 0, 0, 3);

DEFINE_PARAM(QSearchStandPatBetaScale, 484, 1, 1024);
DEFINE_PARAM(QSearchMoveCountPruningThreshold, 3, 2, 5);
DEFINE_PARAM(QSearchAdjBetaScale, 572, 1, 1024);
DEFINE_PARAM(QSearchFutilityPruningOffset, 80, 40, 120);

DEFINE_PARAM(RfpDepth, 6, 4, 10);
DEFINE_PARAM(RfpDepthScaleLinear, 80, 80, 180);
DEFINE_PARAM(RfpDepthScaleQuad, 0, 0, 30);
DEFINE_PARAM(RfpImprovingScale, 148, 50, 200);
DEFINE_PARAM(RfpTreshold, 16, 0, 20);
DEFINE_PARAM(RfpAdjBetaScale, 487, 1, 1024);

DEFINE_PARAM(SSEPruningDepth_Captures, 5, 1, 12);
DEFINE_PARAM(SSEPruningDepth_NonCaptures, 9, 1, 12);
DEFINE_PARAM(SSEPruningMultiplier_Captures, 123, 60, 180);
DEFINE_PARAM(SSEPruningMultiplier_NonCaptures, 43, 10, 100);
...
DEFINE_PARAM(ReductionStatOffset, 6592, 5000, 10000);
DEFINE_PARAM(ReductionStatDiv, 228, 100, 400);

DEFINE_PARAM(EvalCorrectionPawnsScale, 50, 1, 128);
DEFINE_PARAM(EvalCorrectionNonPawnsScale, 64, 1, 128);
DEFINE_PARAM(ContCorrectionScale, 79, 1, 128);
DEFINE_PARAM(CorrHistMaxBonus, 266, 128, 512);
DEFINE_PARAM(CorrHistGravity, 1181, 256, 4096);
DEFINE_PARAM(CorrHistBonusDiv, 4, 1, 8);

DEFINE_PARAM(TTCutoffHalfMoveLimit, 81, 60, 99);
DEFINE_PARAM(AlphaImprovementMinDepth, 2, 1, 6);
DEFINE_PARAM(QuietHistMaxScoreDiff, 268, 64, 512);
DEFINE_PARAM(PriorCMHBonusCap, 1153, 400, 2400);
DEFINE_PARAM(PriorCMHBonusScale, 107, 20, 240);
DEFINE_PARAM(PriorCMHBonusBias, 93, 0, 200);
DEFINE_PARAM(PvTTMoveMinRootDepth, 8, 4, 16);
DEFINE_PARAM(RootSingularMaxScore, 997, 500, 2000);

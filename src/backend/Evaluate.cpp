...
#include <fstream>
    ...
    // use eval file
    const char* c_DefaultEvalFile = "eval-48.pnn";
...
DEFINE_PARAM(EvalScale_Pawns, 2, 0, 20);
DEFINE_PARAM(EvalScale_Knights, 21, 0, 100);
DEFINE_PARAM(EvalScale_Bishops, 16, 0, 100);
DEFINE_PARAM(EvalScale_Rooks, 22, 0, 150);
DEFINE_PARAM(EvalScale_Queens, 51, 0, 200);
DEFINE_PARAM(EvalScale_Offset, 843, 500, 1500);

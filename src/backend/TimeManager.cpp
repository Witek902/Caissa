...
DEFINE_PARAM(TM_ScoreChangeFactorScale, 10, 0, 1000);
DEFINE_PARAM(TM_ScoreChangeFactorOffset, 800, 0, 2000);
DEFINE_PARAM(TM_ScoreChangeMin, -5, -100, 100);
DEFINE_PARAM(TM_ScoreChangeMax, 50, -100, 100);

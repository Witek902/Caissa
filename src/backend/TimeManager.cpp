...
DEFINE_PARAM(TM_MovesLeftMidpoint, 31, 30, 60);
DEFINE_PARAM(TM_MovesLeftSteepness, 223, 150, 260);
DEFINE_PARAM(TM_IdealTimeFactor, 879, 700, 1000);
DEFINE_PARAM(TM_NodesCountScale, 208, 160, 260);
DEFINE_PARAM(TM_NodesCountOffset, 75, 10, 90);
DEFINE_PARAM(TM_StabilityScale, 1, 0, 200);
DEFINE_PARAM(TM_StabilityOffset, 1604, 1000, 2000);
DEFINE_PARAM(TM_ScoreChangeFactorScale, 3, 0, 50);
DEFINE_PARAM(TM_ScoreChangeFactorOffset, 977, 200, 1000);
DEFINE_PARAM(TM_ScoreChangeFactorMin, 47, 10, 90);
DEFINE_PARAM(TM_ScoreChangeFactorMax, 164, 110, 200);

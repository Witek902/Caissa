...
private:
    ...
    struct alignas(64) ThreadData
    {
        ...
        NonPawnCorrTable nonPawnWhiteCorrection;
        NonPawnCorrTable nonPawnBlackCorrection;
        ContCorrTable continuationCorrection;
    ...
    alignas(64) PawnCorrTable mPawnStructureCorrection;

    ScoreType GetEvalCorrection(const ThreadData& threadData, const NodeInfo& node) const;
    ...
    ScoreType AdjustEvalScore(const ThreadData& threadData, const NodeInfo& node, const SearchParam& searchParam) const;

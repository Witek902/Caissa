...
DEFINE_PARAM(QuietBonusLinear, 163, 75, 200);
DEFINE_PARAM(QuietBonusLimit, 1988, 1000, 4000);

DEFINE_PARAM(QuietMalusOffset, -64, -200, 50);
DEFINE_PARAM(QuietMalusLinear, 160, 75, 200);
DEFINE_PARAM(QuietMalusLimit, 1855, 1000, 4000);

DEFINE_PARAM(CaptureBonusOffset, 40, 0, 150);
DEFINE_PARAM(CaptureBonusLinear, 72, 20, 150);
DEFINE_PARAM(CaptureBonusLimit, 2561, 1000, 4000);

DEFINE_PARAM(CaptureMalusOffset, 41, 0, 150);
DEFINE_PARAM(CaptureMalusLinear, 59, 20, 150);
DEFINE_PARAM(CaptureMalusLimit, 2161, 1000, 4000);

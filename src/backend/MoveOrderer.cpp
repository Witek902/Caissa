...
DEFINE_PARAM(QuietBonusOffset, -94, -200, 50);
DEFINE_PARAM(QuietBonusLinear, 155, 75, 200);
DEFINE_PARAM(QuietBonusLimit, 1957, 1000, 4000);

DEFINE_PARAM(QuietMalusOffset, -94, -200, 50);
DEFINE_PARAM(QuietMalusLinear, 155, 75, 200);
DEFINE_PARAM(QuietMalusLimit, 1957, 1000, 4000);

DEFINE_PARAM(CaptureBonusOffset, 39, 0, 150);
DEFINE_PARAM(CaptureBonusLinear, 69, 20, 150);
DEFINE_PARAM(CaptureBonusLimit, 2387, 1000, 4000);

DEFINE_PARAM(CaptureMalusOffset, 39, 0, 150);
DEFINE_PARAM(CaptureMalusLinear, 69, 20, 150);
DEFINE_PARAM(CaptureMalusLimit, 2387, 1000, 4000);

DEFINE_PARAM(ContinuationHistoryScale0, 1024, 512, 2048);
DEFINE_PARAM(ContinuationHistoryScale1, 1024, 512, 2048);
DEFINE_PARAM(ContinuationHistoryScale3, 1024, 512, 2048);
DEFINE_PARAM(ContinuationHistoryScale5, 1024, 512, 2048);

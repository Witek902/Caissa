...
DEFINE_PARAM(QuietMoveHistoryClear, 623, -2000, 2000);
DEFINE_PARAM(ContinuationHistoryClear, 686, -2000, 2000);
DEFINE_PARAM(CapturesHistoryClear, 215, -2000, 2000);

DEFINE_PARAM(QuietBonusOffset, -95, -200, 0);
DEFINE_PARAM(QuietBonusLinear, 164, 100, 250);
DEFINE_PARAM(QuietBonusScoreDiff, 154, 0, 400);
DEFINE_PARAM(QuietBonusLimit, 2126, 1000, 4000);

DEFINE_PARAM(QuietMalusOffset, -51, -200, 50);
DEFINE_PARAM(QuietMalusLinear, 152, 75, 200);
DEFINE_PARAM(QuietMalusScoreDiff, 179, 0, 400);
DEFINE_PARAM(QuietMalusLimit, 1899, 1000, 4000);

DEFINE_PARAM(CaptureBonusOffset, 25, 0, 100);
DEFINE_PARAM(CaptureBonusLinear, 74, 20, 120);
DEFINE_PARAM(CaptureBonusLimit, 2693, 1000, 4000);

DEFINE_PARAM(CaptureMalusOffset, 28, 0, 100);
DEFINE_PARAM(CaptureMalusLinear, 53, 20, 120);
DEFINE_PARAM(CaptureMalusLimit, 1974, 1000, 4000);

...
DEFINE_PARAM(QuietMoveHistoryClear, 633, -2000, 2000);
DEFINE_PARAM(ContinuationHistoryClear, 866, -2000, 2000);
DEFINE_PARAM(CapturesHistoryClear, -140, -2000, 2000);

DEFINE_PARAM(QuietBonusOffset, -73, -200, 0);
DEFINE_PARAM(QuietBonusLinear, 172, 100, 250);
DEFINE_PARAM(QuietBonusScoreDiff, 185, 0, 400);
DEFINE_PARAM(QuietBonusLimit, 2044, 1000, 4000);

DEFINE_PARAM(QuietMalusOffset, -38, -200, 50);
DEFINE_PARAM(QuietMalusLinear, 154, 75, 200);
DEFINE_PARAM(QuietMalusScoreDiff, 235, 0, 400);
DEFINE_PARAM(QuietMalusLimit, 1350, 1000, 4000);

DEFINE_PARAM(CaptureBonusOffset, 19, 0, 100);
DEFINE_PARAM(CaptureBonusLinear, 59, 20, 120);
DEFINE_PARAM(CaptureBonusLimit, 2622, 1000, 4000);

DEFINE_PARAM(CaptureMalusOffset, 16, 0, 100);
DEFINE_PARAM(CaptureMalusLinear, 66, 20, 120);
DEFINE_PARAM(CaptureMalusLimit, 1953, 1000, 4000);

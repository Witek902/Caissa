...
DEFINE_PARAM(QuietBonusLimit, 2017, 1000, 4000);
...
DEFINE_PARAM(CaptureBonusLinear, 76, 20, 150);
DEFINE_PARAM(CaptureBonusLimit, 2646, 1000, 4000);

DEFINE_PARAM(CaptureMalusOffset, 37, 0, 150);
DEFINE_PARAM(CaptureMalusLinear, 56, 20, 150);
DEFINE_PARAM(CaptureMalusLimit, 2110, 1000, 4000);

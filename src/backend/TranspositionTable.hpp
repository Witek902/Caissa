...
public:
    ...
    void Write(const Position& position, ScoreType score, ScoreType staticEval, uint32_t depth, TTEntry::Bounds bounds, bool isPv, PackedMove move = PackedMove::Invalid());

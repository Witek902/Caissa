...
public:
    ...
    void UpdateContinuationHistory(const NodeInfo& node, const Move move, int32_t delta);
...
private:
    ...
    CounterType capturesHistory[2][2][2][6][5][64];         // stm, from-threated, to-threated, capturing piece, captured piece, to-square

...
* [CCRL 40/15](https://ccrl.chessdom.com/ccrl/4040/) - **3439** (#17) (version 1.9 4CPU)
* [CCRL 40/2](https://ccrl.chessdom.com/ccrl/404/) - **3588** (#18) (version 1.7 8CPU)
...
* [CEGT 40/20](http://www.cegt.net/40_40%20Rating%20List/40_40%20SingleVersion/rangliste.html) - **3431** (#18) (version 1.10)
...
#### Evaluation
* Neural network evaluation
  * (5x768&rarr;768)x2&rarr;1 architecture
